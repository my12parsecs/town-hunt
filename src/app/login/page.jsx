...
export const metadata = {
  title: "Login | Town Hunt",
  description: "Sign in to Town Hunt",
}
...
export default async function Login() {
  ...
  return (
    <div className="login-page">
      ...
      <h1 className="login-title">Town Hunt</h1>
      <p className="login-text">Quickly bookmark places.</p>
      ...
      <Link href={`${process.env.NEXT_PUBLIC_BACKEND_DOMAIN}/google`} className="login-form">
